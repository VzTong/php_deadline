...
$data = db_select("SELECT * FROM product where data_type = 'Kitchen'");
...
<!---->
<!--	ba - ba1 - ba2	//ki - ki1 - ki2 // of21 -> of35  -->
<!-- Carousel
    ================================================== -->
...
<div class="kic-top ">
	<div class="container ">
		...
		<div class="col-md-4 kic-top1">
			<a href="single.php">
				<img src="<?php asset("images/ki.jpg") ?>" class="img-responsive" alt="">
			</a>
			<h6>Dal</h6>
		...
		<div class="col-md-4 kic-top1">
			<a href="single.php">
				<img src="<?php asset("images/ki1.jpg") ?>" class="img-responsive" alt="">
			</a>
			<h6>Snacks</h6>
			<p>Nam libero tempore</p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="single.php">
				<img src="<?php asset("images/ki2.jpg") ?>" class="img-responsive" alt="">
			</a>
			<h6>Spice</h6>
			<p>Nam libero tempore</p>
		</div>
