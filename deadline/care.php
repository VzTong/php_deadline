...
$data = db_select("SELECT * FROM product where data_type = 'Personal Care'");
?>
...
<!---->
<!--	ba - ba1 - ba2 //	ki3 - ki4 - k5 // of36 -> of47 -->
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<a href="care.php"><img class="first-slide" src="<?php asset("images/ba1.jpg") ?>" alt="First slide"></a>

		</div>
		<div class="item">
			<a href="kitchen.php"><img class="second-slide " src="<?php asset("images/ba.jpg") ?>" alt="Second slide"></a>
...
<div class="kic-top ">
	<div class="container ">
		...
		<div class="col-md-4 kic-top1">
			<a href="single.php">
				<img src="<?php asset("images/ki3.jpg") ?>" class="img-responsive" alt="">
			</a>
			<h6>Natural Cream</h6>
		...
		<div class="col-md-4 kic-top1">
			<a href="single.php">
				<img src="<?php asset("images/ki4.jpg") ?>" class="img-responsive" alt="">
			</a>
			<h6>Shaving Kit</h6>
			<p>Nam libero tempore</p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="single.php">
				<img src="<?php asset("images/ki5.jpg") ?>" class="img-responsive" alt="">
			</a>
			<h6>Makeup Kit</h6>
			<p>Nam libero tempore</p>
		</div>
