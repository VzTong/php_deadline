		...
		<div class="single-top-main">
			<div class="col-md-5 single-top">
				<div class="single-w3agile">
					...
					<div id="picture-frame">
						<img src="<?php asset("images/si.jpg") ?>" data-src="<?php asset("images/si-1.jpg") ?>" alt="" class="img-responsive" />
					</div>
					<script src="<?php asset("js/jquery.zoomtoo.js") ?>"></script>
					<script>
						$(function() {
			...
			<div class="col-md-7 single-top-left ">
				<div class="single-right">
					...
					<div class="add add-3">
						<button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="Wheat" data-summary="summary 1" data-price="6.00" data-quantity="1" data-image="<?php asset("images/si.jpg") ?>">Add to Cart</button>
					</div>
